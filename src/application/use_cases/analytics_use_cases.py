"""Analytics use cases — compliance dashboard aggregation."""
...
class AnalyticsUseCases:
    ...
    async def get_trend(
        ...
        # Simplified: returns last N days with synthetic trend until historical data is available
