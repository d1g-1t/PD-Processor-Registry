"""Processor Review — privacy risk assessment for a vendor."""
...
class ProcessorReview:
    ...
    review_status: str = "PENDING"  # PENDING | IN_PROGRESS | COMPLETED | EXPIRED
    ...
    def should_reject(self) -> bool:
        """Review exceeds rejection threshold (set at use-case level)."""
