"""Activity risk recalculation task."""
...
def recalculate_activity_risk_task(activity_id: str) -> dict:
    """Load activity + legal basis + localization + transfers, run rule engine, persist findings."""
    ...
    # In production, this would load from DB synchronously (Celery is sync).
    # For now, return a stub structure showing the pattern.
    context = {
