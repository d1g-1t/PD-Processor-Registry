"""LLM explainer — assistive layer, NEVER primary compliance truth.

All prompts return structured JSON. Every call is logged with prompt hash.
Human review is required before sending subject-facing responses.
"""
...
class PromptLoader:
    """Load and cache prompt templates from disk, track versions via SHA-256."""
...
class LLMExplainerService:
    """Wraps Ollama via LangChain for explanation / drafting tasks."""
